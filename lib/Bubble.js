...
export default class Bubble extends React.Component {
    constructor() {
        ...
        this.onLongPress = (a, b) => {
            ...
            if (this.props.onLongPress) {
            ...
            else if (currentMessage && (currentMessage.text || currentMessage.Task)) {
                ...
                this.context.actionSheet().showActionSheetWithOptions({
                    ...
                    switch (buttonIndex) {
                        case 0:
                            Clipboard.setString(currentMessage.text || currentMessage.TaskDetails);
                            break;
                        default:
                            break;
                    }
    ...
    componentDidUpdate(prevProps) {
        // console.log('prevProps', this.props.scrollToMessage, this.props.currentMessage?._id, this.props.currentMessage?._id === this.props.scrollToMessage)
        // console.log(this.current)
        // if (
        //     this.props.currentMessage?._id === this.props.scrollToMessage
        // ) {
        //     console.log('py', 'here I am')
        //     this.current.measure((fx, fy, width, height, px, py) => {
        //         console.log('py measure', fx, fy, width, height, px, py)
    ...
    renderMessageText() {
        if (this.props.currentMessage && this.props.currentMessage) {
    ...
    render() {
        ...
        return (<View style={[
            ...
            <View style={[
                ...
                <TouchableWithoutFeedback accessibilityTraits='text' {...this.props.touchableProps} onLongPress={this.onLongPress}  >
                    <View>
